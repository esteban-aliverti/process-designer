{
	...
	"stencils" : [
		...
		// end custom workitems 
			...
			"title_de" :		"Wiederverwendbares Unterprozess",
			"groups" :			["Activities"],
			"groups_de" :		["Activities"],
			"description" :		"A reusable subprocess. It can be used to invoke another process.",
			"description_de" :	"A reusable subprocess. It can be used to invoke another process.",
			...
			"properties" :		[
				...
				},
				{
					...
					"description_de":"If true this sub-process node will only continue if the child process that was started has terminated its execution (completed or aborted)",
					"readonly":false,
					"optional":true,
					"items": [
						{
		...
		}, 
		{
			...
			"title_de" :		"Multiple instances",
			"groups" :			["Activities"],
			"groups_de" :		["Activities"],
			"description" :		"A multiple instances subprocess. Allows to execute the contained process segment multiple times.",
			"description_de" :	"A multiple instances subprocess. Allows to execute the contained process segment multiple times.",
